...
<%@ page import="java.util.Vector,noticeboard.*,java.text.SimpleDateFormat"%>
<%
...
<script language=JavaScript src="noticeboardForm.js"></script>
...
<center>
	...
	<div id="content">
		...
		<center>
			<% 
				...
				Vector<NoticeBean> list = brddb.getBoardList(); 
		    ...
		    <tr bgcolor=<%=color %> 
		       ...
		       <td align=left><a href="noticereadBoard.jsp?num=<%= brd.getNum()%>"><%= brd.getTitle() %></a></td>
	...
	%>
		<form name=form method=post action="noticeeditBoard.jsp">
